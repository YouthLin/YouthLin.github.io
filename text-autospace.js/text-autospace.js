...
*/
;//https://github.com/mastermay/text-autospace.js//http://mastermay.github.io/text-autospace.js/
(function (window, $) {
    var init = function ($node) {/////////////////////////////////////////////////////
        var $selector = $node || $('body');///////////////////////////////////////
        ...
        //////////////////////////////////////////////////////////////////////////
        $('hanla').html(' ');
        $('code hanla,pre hanla,kbd hanla,samp hanla,ol hanla,ul hanla').html('');
        //////////////////////////////////////////////////////////////////////////
    };
    window.autoSpaceAt = init;
    findAndReplaceDOMText = function (a, b) {
        b.filterElements = function (el) {
            var name = el.nodeName.toLowerCase(),
                classes = (el.nodeType === 1) ? el.getAttribute('class') : '',
                charized = !!(classes && classes.match(/han-js-charized/) !== null);
...
function copyText(obj) {//https://www.jqueryscript.net/demo/Copy-Text-To-Clipboard-jQuery-Copy/
    if (!obj) {
        return false;
    }
    var text;
